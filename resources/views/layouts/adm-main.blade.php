...
<head>
    ...
    <style>
        @font-face {
            ...
            src: url('{!! asset('fonts/SFProBold.ttf') !!}') format('truetype');
            font-weight: bold;
            font-style: normal;
        }

        body {
            font-family: 'SF Pro Bold', 'Nunito', sans-serif;
        ...
        .topbar .navbar-search .input-group .btn {
            background-color: #4e73df;
            border: none;
        }
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('barang.index') }}" data-toggle="collapse"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset('images/fadhlan.jpeg') }}">
                            </a>
                ...
                <footer class="footer">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>&copy; 2024 Sinvent. All Rights Reserved.</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
    ...
    <script>
        $(document).ready(function() {
            // Additional JS for enhancements can be added here
        });
    </script>
</body>
